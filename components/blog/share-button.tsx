...
const SHARE_PROVIDERS = [
  {
    label: "X",
    color: "bg-muted/80 text-foreground border border-border/60 hover:bg-muted",
    icon: (
  ...
  },
  {
    label: "Telegram",
    color: "bg-muted/80 text-foreground border border-border/60 hover:bg-muted",
    icon: <HugeiconsIcon icon={SentIcon} className="size-5 text-foreground" strokeWidth={2} />,
    getUrl: (url: string, title: string) => `https://t.me/share/url?url=${url}&text=${title}`,
  },
  {
    label: "Email",
    color: "bg-muted/80 text-foreground border border-border/60 hover:bg-muted",
    icon: <HugeiconsIcon icon={Mail01Icon} className="size-5 text-foreground" strokeWidth={2} />,
