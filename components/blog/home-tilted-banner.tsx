...
export function HomeTiltedBanner() {
  return (
    <section className="relative w-screen left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] my-6 sm:my-10 md:my-14 py-14 sm:py-24 md:py-32 bg-zinc-950 dark:bg-black text-zinc-100 overflow-hidden [clip-path:polygon(0_3vw,100%_0,100%_calc(100%-3vw),0_100%)]">
