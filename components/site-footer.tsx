...
export function SiteFooter() {
  ...
  return (
    <footer className="mt-auto w-full overflow-hidden">
      {/* Outer Wrapper for Tilted Black Container & Top Tilted Line */}
      <div className="relative w-screen left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] pt-2 pb-1">
        {/* Single Top Tilted Accent Line */}
        <div
          className="absolute inset-0 pointer-events-none bg-zinc-950 dark:bg-black"
          style={{
            clipPath:
              "polygon(0 calc(3vw + 1.5px), 100% 1.5px, 100% calc(1.5px + 2px), 0 calc(3vw + 1.5px + 2px))",
          }}
        />

        {/* Dark Main Footer Block (Full Bleed Parallel Diagonal Tilted Top & Bottom Edges) */}
        <div className="relative w-full bg-zinc-950 text-zinc-100 dark:bg-black my-1 pt-16 sm:pt-24 md:pt-28 pb-16 sm:pb-24 md:pb-28 px-4 sm:px-6 md:px-8 [clip-path:polygon(0_3vw,100%_0,100%_calc(100%-3vw),0_100%)]">
